...
- (id)initWithImagePickerController:(AGImagePickerController *)imagePickerController asset:(ALAsset *)asset andDelegate:(id<AGIPCGridItemDelegate>)delegate
{
    ...
    if (self)
    {
        ...
        self.checkmarkImageView = [[UIButton alloc] initWithFrame:CGRectMake( frame.size.width - checkmarkRect.size.width*0.7 - checkmarkRect.origin.x,
                                                                             frame.size.height - checkmarkRect.size.height*0.7 - checkmarkRect.origin.y,
                                                                             checkmarkRect.size.width*0.7,
                                                                             checkmarkRect.size.height*0.7)];
